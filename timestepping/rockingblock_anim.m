function F = rockingblock_anim(sys,t,q,aviname,antialias)
% rockingblock_anim.m: animation file for rockingblock_sys.m
%
% Remco Leine
...
for i=1:K:N;  
 ...
 blockfun('draw',block,x,y,phi,a,b,'r');
 supportfun('draw',support,midxpos,midypos,a*20,a*10,gray);
...
switch flag
 case 'init'
  ...
  varargout{1} = object;
 case 'draw'
  set(object,'Position',[-r+x0,y0-r,2*r,2*r],'Curvature',[1,1],'FaceColor',color);
  varargout{1} = 1;
end
%------------------------------------------------------------------
