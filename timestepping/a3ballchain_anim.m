function F = a3ballchain_anim(sys,t,q,aviname,antialias)
% a3ballchain_anim.m: animation file for sys_3ballchain.m
%
% Remco Leine
...
for i=1:K:N  
 ...
 circlefun('draw',balls(1),x(1),midypos,R,'r');
 circlefun('draw',balls(2),x(2),midypos,R,'magenta');
 circlefun('draw',balls(3),x(3),midypos,R,'b');
